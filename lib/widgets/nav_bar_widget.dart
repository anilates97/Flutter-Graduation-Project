...
class _NavBarWidgetState extends ConsumerState<NavBarWidget> {
  ...
  late PersistentTabController _controllerLogOut;
  ...
  void initState() {
    ...
    _controllerLogOut = PersistentTabController(initialIndex: currentIndex);
    categoriesPage = CategoriesPage(bookID: widget.bookID);
    screensWithLogin = [homePage, myLibraryPage, categoriesPage];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PersistentTabView(
      ...
      screens: _authService.getCurrentUser() != null
          ? [homePage, myLibraryPage, categoriesPage, usersPage]
          : [homePage, categoriesPage, loginPage],

      items: _authService.getCurrentUser() != null
          ? _navBarsItemsWithLogin(_authService)
          : _navBarsItemsWithLogout(_authService),
